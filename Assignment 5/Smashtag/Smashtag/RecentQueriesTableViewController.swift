...
class RecentQueriesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        let cell = tableView.cellForRow(at: indexPath)
        performSegue(withIdentifier: "Show Popular Users And Hashtags", sender: cell)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "RecentQueryCell" {
        ...
        if segue.identifier == "Show Popular Users And Hashtags" {
            print("segue")
            
            if let searchMentionCounterTVC = segue.destination as? SearchMentionCounterTableViewController,
                let recentQueryCell = sender as? RecentQueryTableViewCell,
                let recentQuery = recentQueryCell.recentQuery {
